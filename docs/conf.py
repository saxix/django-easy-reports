...
htmlhelp_basename = 'DjangoEasyReports'
...
latex_documents = [
    ('index', 'djangoeasyreports.tex', u"Django Easy Reports Documentation",
...
man_pages = [
    ('index', 'djangoeasyreports', u"Django Admin Actions Documentation",
